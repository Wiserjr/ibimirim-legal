const CACHE='municipio-legal-v8';
const CORE=['./','./index.html','./styles.css','./qa.css','./app.js','./municipio.js','./manifest.webmanifest','./icons/icon.svg','./data/laws.js','./data/fees.js','./LEIA-ME.txt'];
