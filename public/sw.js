const CACHE='ibimirim-legal-v6';
const CORE=['./','./index.html','./styles.css','./qa.css','./app.js','./content.js','./manifest.webmanifest','./icons/icon.svg','./data/laws.json','./data/fees.json','./LEIA-ME.txt'];
