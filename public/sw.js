const CACHE='ibimirim-legal-v7';
const CORE=['./','./index.html','./styles.css','./qa.css','./app.js','./content.js','./manifest.webmanifest','./icons/icon.svg','./data/laws.js','./data/fees.js','./LEIA-ME.txt'];
